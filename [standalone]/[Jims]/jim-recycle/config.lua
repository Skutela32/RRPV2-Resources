...
Config = {
	...
	ScrapyardSearching = {
		Enable = false,
		searched = { }, -- No Touch
		skillcheck = "ox-lib", --"qb-lock", "ps-ui", "qb-skillbar", "ox_lib", nil
	...
	PayAtDoor = 50, -- Set to nil stop turn this off, set to a number to enable
	...
	RecycleAmounts = {
		...
		["Trade"] = {
            { amount = 2, itemGive = 1, Min = 1, Max = 2, },
            { amount = 10, itemGive = 5, Min = 10, Max = 11, },
            { amount = 100, itemGive = 10, Min = 100, Max = 110, },
            { amount = 200, itemGive = 10, Min = 200, Max = 220, },
            { amount = 1000, itemGive = 10, Min = 1000, Max = 1100, },
		},
	}
}
