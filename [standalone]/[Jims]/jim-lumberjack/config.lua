...
--Ores and Props
	...
	Items = {
		...
		items = {
			{ name = "powersaw", price = 1000, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "water_bottle", price = 2, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "sandwich", price = 2, amount = 250, info = {}, type = "item", slot = 3, },
			{ name = "bandage", price = 5, amount = 100, info = {}, type = "item", slot = 4, },
		},
	},
}
