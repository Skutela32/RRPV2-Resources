RegisterKeyMapping("nakres_lightbar:toggleLightbars","On/Of vehicle lightbar","KEYBOARD","Q")
RegisterKeyMapping("nakres_lightbar:toggleLightbarAudio","On/Of vehicle siren Audio","KEYBOARD","LMENU")
RegisterKeyMapping("nakres_lightbar:changeLightbarAudio","Change vehicle siren Audio","KEYBOARD","R")
RegisterKeyMapping('+nakres_lightbar:sirenHorn', 'turn on Siren Horn', 'keyboard', '')
