...
elseif DS_Casino_System_Main_Config.MapType == 1 then
    ...
    --LUCKY WHEEL
    DS_Casino_System_LuckWheel.WheelPos = vec3(949.696777, 45.061569, 70.932759)
...
elseif DS_Casino_System_Main_Config.MapType == 2 then
    ...
    --LUCKY WHEEL
    DS_Casino_System_LuckWheel.WheelPos = vec3(964.643250, 49.322929, 80.856282)
    ...
    ___arrow1 = CreateObject(___m2a, DS_Casino_System_LuckWheel.WheelPos.x, DS_Casino_System_LuckWheel.WheelPos.y, DS_Casino_System_LuckWheel.WheelPos.z+2.5, false, false, true)
    SetEntityHeading(___arrow1, DS_Casino_System_LuckWheel.Heading)
    SetModelAsNoLongerNeeded(___arrow1)
...
elseif DS_Casino_System_Main_Config.MapType == 3 then
    ...
    --LUCKY WHEEL
    DS_Casino_System_LuckWheel.WheelPos = vec3(990.270874, 42.799438, 70.560081)
    DS_Casino_System_LuckWheel.Heading = 328.0
...
elseif DS_Casino_System_Main_Config.MapType == 4 then
    ...
    if custom_luckywheel_spawnbase then
        ___baseeee = CreateObject(joaat('vw_prop_vw_luckywheel_01a'), DS_Casino_System_LuckWheel.WheelPos.x, DS_Casino_System_LuckWheel.WheelPos.y, DS_Casino_System_LuckWheel.WheelPos.z-0.3, false, false, true)
        SetEntityHeading(___baseeee, DS_Casino_System_LuckWheel.Heading)
        SetModelAsNoLongerNeeded(___baseeee)
    end
