...
GlobalState.MoneyReward = math.random(5000, 10000) -- amount of money that will be given (between 5000 and 10000, can be edited) as a reward (only if GlobalState.Reward is "money")
