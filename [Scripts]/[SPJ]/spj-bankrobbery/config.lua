...
---- ** FLEECA ** ----
Config.FleecaBagsMin = 8 -- How many bags of Marked Bills can you MINIMUM get from a FLeeca Table?
Config.FleecaBagsMax = 10 -- How many bags of Marked Bills can you MAXIMUM get from a FLeeca Table?
Config.FleecaGoldMin = 2 -- Minimum gold bars from Fleecas
Config.FleecaGoldMax = 4 -- Maximum gold bars from Fleecas

---- ** PALETO ** ----
Config.PaletoBagsMin = 7 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Table?
Config.PaletoBagsMax = 10 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Table?
Config.PaletoGoldMin = 7 -- Minimum gold bars from Paleto
Config.PaletoGoldMax = 9 -- Maximum gold bars from Paleto

---- ** PALETO SECOND ** ----
Config.PaletoSecondMinBags = 7 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Second Table
Config.PaletoSecondMaxBags = 10 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Second Table?
...
---- ** PACIFIC LOOT TABLES ** ----
Config.PacificBagsMin = 20 -- How many bags of Marked Bills can you MINIMUM get from a pacific Table?
Config.PacificBagsMax = 30 -- How many bags of Marked Bills can you MAXIMUM get from a pacific Table?
Config.PacificGoldMin = 10 -- Minimum gold bars from pacific
Config.PacificGoldMax = 18 -- Maximum gold bars from pacific
