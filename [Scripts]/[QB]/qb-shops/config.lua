...
Config.Products = {
    ['normal'] = {
        {name = 'tosti',         price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'water_bottle',  price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'vape',          price = 100, amount = 2,   info = {}, type = 'item'},
        {name = 'kurkakola',     price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'twerks_candy',  price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'snikkel_candy', price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'sandwich',      price = 5,   amount = 5,   info = {}, type = 'item'},
        {name = 'beer',          price = 30,  amount = 5,   info = {}, type = 'item'},
        {name = 'whiskey',       price = 100, amount = 5,   info = {}, type = 'item'},
        {name = 'vodka',         price = 120, amount = 5,   info = {}, type = 'item'},
        {name = 'bandage',       price = 100, amount = 5,   info = {}, type = 'item'},
        {name = 'lighter',       price = 2,   amount = 5,   info = {}, type = 'item'},
        {name = 'rolling_paper', price = 2,   amount = 500, info = {}, type = 'item'},
    },
    ['liquor'] = {
        {name = 'beer',    price = 30,  amount = 50, info = {}, type = 'item'},
    ...
    ['weedshop'] = {
        {name = 'joint',          price = 100,  amount = 50,   info = {}, type = 'item'},
        {name = 'weapon_poolcue', price = 1000, amount = 50,   info = {}, type = 'item'},
    ...
    ['weapons'] = {
        ...
        {name = 'weapon_hatchet',       price = 3000,  amount = 250, info = {}, type = 'weapon'},
        {name = 'pistol_ammo',          price = 1000,  amount = 250, info = {}, type = 'item',   requiredLicense = { 'weapon' }},
        {name = 'weapon_pistol',        price = 20000, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
