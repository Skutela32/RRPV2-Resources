...
Config.BankTimer = 60 -- How many minutes between each bank robbery?

---- ** BAG IDs ** ----
Config.BagUseID = 0 -- Which ID is the bag that a player gets after doing an animation? (Should use a black one so it looks close to the animation)
...
Config.lowerVaultEnabled = false
...
Config.MinimumPAleto2 = 5
Config.MinimumPacificPolice = 6
Config.MinimumlowerVaultPolice = 8 -- This also includes thermite in the lower Vault
...
---- ** DOOR COOLDOWN ** ----
Config.DoorCD = 0.5 -- How many minutes before Bank Vault opens after finishing the hack?

---- ** Trolly CONFIG ** ----

Config.FleecaTrollyChance = 75 -- How many percent chance of getting a extra trolley with loot
Config.FleecaGoldTrollyChance = 10 -- How many percent chance of that Fleeca Trolly to be gold

Config.PaletoTrollyChance = 75 -- How many percent chance of getting a extra trolley with loot
Config.PaletoGoldTrollyChance = 25 -- How many percent chance of that Fleeca Trolly to be gold

Config.PacificTrollyChance = 75 -- How many percent chance of getting a extra trolley with loot
Config.PacificGoldTrollyChance = 50 -- How many percent chance of that Fleeca Trolly to be gold
...
Config.Doorlocks = "ox" -- Put 'nui' if you use NUI doorlocks
...
---- ** FLEECA HACK CONFIG ** ----
Config.FleecaTime = 60 -- How much time do they have to enter the hack?
...
---- ** PALETO HACK CONFIG ** ----
Config.PaletoTime = 40 -- How much time do they have to enter the hack?
...
---- ** PACIFIC HACK CONFIG ** ----
Config.PacificTime = 40 -- How much time do they have to enter the hack?
Config.PacificBlocks = 5 -- How many different blocks can the hack have?
Config.PacificRepeat = 3 -- How many times in a row do they need to hack the system?

---- ** LOWER VAULT HACK CONFIG ** ----
Config.HDDTime = 60 -- How much time do they have to enter the hack?
...
Config.CorrectBlocks = 8 -- correctBlocks = Number of correct blocks the player needs to click
Config.IncorrectBlocks = 2 -- incorrectBlocks = number of incorrect blocks after which the game will fail
...
Config.MarkedBillsWorthMin = 6000 -- Minimum worth of a bag
Config.MarkedBillsWorthMax = 12000 -- Maximum worth of a bag
-- NOTES --
...
---- ** FLEECA ** ----
Config.FleecaBagsMin = 4 -- How many bags of Marked Bills can you MINIMUM get from a FLeeca Table?
Config.FleecaBagsMax = 5 -- How many bags of Marked Bills can you MAXIMUM get from a FLeeca Table?
Config.FleecaGoldMin = 2 -- Minimum gold bars from Fleecas
Config.FleecaGoldMax = 3 -- Maximum gold bars from Fleecas

---- ** PALETO ** ----
Config.PaletoBagsMin = 3 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Table?
Config.PaletoBagsMax = 5 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Table?
Config.PaletoGoldMin = 3 -- Minimum gold bars from Paleto
Config.PaletoGoldMax = 5 -- Maximum gold bars from Paleto

---- ** PALETO SECOND ** ----
Config.PaletoSecondMinBags = 3 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Second Table
Config.PaletoSecondMaxBags = 5 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Second Table?
...
---- ** PACIFIC LOOT TABLES ** ----
Config.PacificBagsMin = 10 -- How many bags of Marked Bills can you MINIMUM get from a pacific Table?
Config.PacificBagsMax = 15 -- How many bags of Marked Bills can you MAXIMUM get from a pacific Table?
Config.PacificGoldMin = 5 -- Minimum gold bars from pacific
Config.PacificGoldMax = 9 -- Maximum gold bars from pacific
...
Config.Lockers = {
    ["Fleeca"] = {
        ...
        ["ItemAmount"] = math.random(4,10), -- Put minimum and Maximum amount of items inside the randomiser
        ---- RARE ITEMS ----
