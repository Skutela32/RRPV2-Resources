...
RegisterNetEvent('jim-mechanic:client:Menu', function(editable)
	...
	local CheckTable = {
		...
		[2] = { lock = true, part = "engine", desc = Loc[Config.Lan]["common"].stock..": [LVL 0 / "..GetNumVehicleMods(vehicle, 11).."]", head = Loc[Config.Lan]["check"].label1 },
		[3] = { lock = true, part = "brakes", desc = Loc[Config.Lan]["common"].stock..": [LVL 0 / "..GetNumVehicleMods(vehicle, 12).."]", head = Loc[Config.Lan]["check"].label2 },
		[4] = { lock = true, part = "suspension", desc = Loc[Config.Lan]["common"].stock..": [LVL 0 / "..GetNumVehicleMods(vehicle, 15).."]", head = Loc[Config.Lan]["check"].label3 },
		[5] = { lock = true, part = "transmission", desc = Loc[Config.Lan]["common"].stock..": [LVL 0 / "..GetNumVehicleMods(vehicle, 13).."]", head = Loc[Config.Lan]["check"].label4 },
	...
	--Engine--
	if GetNumVehicleMods(vehicle,11) == 0 then CheckTable[2].head = Loc[Config.Lan]["check"].label1.." "..Loc[Config.Lan]["check"].unavail CheckTable[2].desc = nil end
	if GetVehicleMod(vehicle, 11) ~= -1 then local lvl = (GetVehicleMod(vehicle, 11)+1) CheckTable[2].lock = false
		CheckTable[2].desc = QBCore.Shared.Items[CheckTable[2].part..lvl].label..": [LVL "..lvl.." / "..GetNumVehicleMods(vehicle, 11).."]"
		CheckTable[2].icon = "nui://"..Config.System.img..QBCore.Shared.Items[CheckTable[2].part..lvl].image
	end
	--Brakes--
	if GetNumVehicleMods(vehicle, 12) == 0 then CheckTable[3].head = Loc[Config.Lan]["check"].label2.." "..Loc[Config.Lan]["check"].unavail CheckTable[3].desc = nil end
	if GetVehicleMod(vehicle, 12) ~= -1 then local lvl = (GetVehicleMod(vehicle, 12)+1) CheckTable[3].lock = false
		CheckTable[3].desc = QBCore.Shared.Items[CheckTable[3].part..lvl].label..": [LVL "..lvl.." / "..GetNumVehicleMods(vehicle, 12).."]"
		CheckTable[3].icon = "nui://"..Config.System.img..QBCore.Shared.Items[CheckTable[3].part..lvl].image
	end
	--Suspension--
	if GetNumVehicleMods(vehicle,15) == 0 then CheckTable[4].head = Loc[Config.Lan]["check"].label3.." "..Loc[Config.Lan]["check"].unavail CheckTable[4].desc = nil end
	if GetVehicleMod(vehicle, 15) ~= -1 then local lvl = (GetVehicleMod(vehicle, 15)+1) CheckTable[4].lock = false
		CheckTable[4].desc = QBCore.Shared.Items[CheckTable[4].part..lvl].label..": [LVL "..lvl.." / "..GetNumVehicleMods(vehicle, 15).."]"
		CheckTable[4].icon = "nui://"..Config.System.img..QBCore.Shared.Items[CheckTable[4].part..lvl].image
	end
	--Transmission--
	if GetNumVehicleMods(vehicle,13) == 0 then CheckTable[5].head = Loc[Config.Lan]["check"].label4.." "..Loc[Config.Lan]["check"].unavail CheckTable[5].desc = nil end
	if GetVehicleMod(vehicle, 13) ~= -1 then local lvl = (GetVehicleMod(vehicle, 13)+1) CheckTable[5].lock = false
		CheckTable[5].desc = QBCore.Shared.Items[CheckTable[5].part..lvl].label.." [LVL "..lvl.." / "..GetNumVehicleMods(vehicle, 13).."]"
