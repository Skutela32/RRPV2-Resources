...
Config.EnableAmmoCounter = false
Config.EnableShowMaxAmmo = false

Config.EnableSeatBelt = false
...
Config.DisableGTAHudInVehicle = false -- removes the natives gta 5 display of street names, etc.
...
Config.FirstSpeedometer = 'linear' -- 'circle' / 'linear'
